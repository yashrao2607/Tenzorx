...
const Navbar = () => {
  ...
  return (
    <div className='sticky top-4 z-[100] px-4 md:px-0'>
      <div className='flex items-center justify-between py-3 px-8 glass-card mx-auto max-w-7xl backdrop-blur-3xl border-white/40 shadow-xl'>
        ...
        {/* Desktop Navigation */}
        <ul className='hidden lg:flex items-center gap-8 font-black text-slate-500 text-[11px] tracking-[0.15em]'>
        ...
        <div className='flex items-center gap-4'>
          {token && userData ? (
            ...
            <button onClick={() => navigate('/login')} className='btn-primary px-8 py-3.5 text-[10px] font-black tracking-[0.2em] hidden md:block'>
              CREATE PROFILE
            </button>
          )}
