    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="glass-card p-6">
          ...
          <p className="text-2xl font-bold">₹{cost_analysis.base_cost_estimate.toLocaleString()}</p>
        </div>
        <div className="glass-card p-6 border-teal-500/30">
          ...
          <p className="text-2xl font-bold text-teal-400">₹{cost_analysis.risk_adjusted_cost.toLocaleString()}</p>
        </div>
        <div className="glass-card p-6">
          <p className="text-slate-400 text-xs mb-1 uppercase tracking-wider">Min Market Price</p>
          <p className="text-2xl font-bold">₹{cost_analysis.min_cost.toLocaleString()}</p>
        </div>
        <div className="glass-card p-6 border-blue-500/30">
          ...
          <p className="text-2xl font-bold text-blue-400">₹{cost_analysis.savings_opportunity.toLocaleString()}</p>
        </div>
      </div>
